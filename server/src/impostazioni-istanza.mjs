...
export const CAMPI_ISTANZA = [
  // -- L'AI: chat, trascrizione, immagini -----------------------------------
  {
    chiave: 'TALK_AI_CHIAVI',
    gruppo: 'ai',
    etichetta: 'Chi paga',
    aiuto:
      "«istanza»: la chiave qui sotto vale per tutti, e paghi tu. «utente»: ognuno collega la propria dalle sue impostazioni e consuma il proprio credito, e la tua non viene usata. «mista»: chi ha la propria usa quella, gli altri ricadono sulla tua.",
    tipo: 'scelta',
...
export const GRUPPI_ISTANZA = [
  ...
  { id: 'gif', nome: 'GIF', sotto: 'La ricerca delle GIF nel compositore dei messaggi.' },
  {
    id: 'immagini',
    nome: 'Immagini',
    sotto: 'Cercarle su Unsplash, o generarle da una Stable Diffusion sulla tua rete.',
  },
  { id: 'musica', nome: 'Musica', sotto: 'La sessione di ascolto condiviso via Spotify.' },
];
